...
//			}
  ...
  public void beforeTest(@Optional("androidOnly")String emulator, String platformName, String udid, String deviceName, 
	...
	public void click(WebElement e, String msg) {
		  waitForVisibility(e);
		  utils.log().info(msg); //Sending to log4j logger
		  e.click();
		  ExtentReport.getTest().log(Status.INFO, msg); //Sending to the Extent Report
	...
	public void closeApp() {
		utils.log().info("Close App Method Invoked");
		  switch(getPlatform()){
			  case "Android":
	  ...
	  public void launchApp() {
		  utils.log().info("Launch App Method Invoked---------------------------------------------------------------");
		  switch(getPlatform()){
			  case "Android":
